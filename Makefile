...
php80-12.16.1: $(path)
	docker buildx build --push --platform linux/arm64/v8,linux/amd64 --tag bigbossstudio/php-apache-node:8.0-12.16.1 $(path)/8.0/12.16.1

all: php73-12.16.1 php73-nvm php74-12.16.1 php74-nvm php80-12.16.1 php80-nvm
